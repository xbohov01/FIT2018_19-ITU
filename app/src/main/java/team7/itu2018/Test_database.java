...
public class Test_database {
   ...
   public Test_database(){
    ...
    public int GetQType(int QNumber){
        return quest[QNumber].getQType();
    }

    public int GetPoints(int QNumber){
        return quest[QNumber].getPoints();
    }

    public String GetPicture(int QNumber){
        return quest[QNumber].getPicture();
    }
